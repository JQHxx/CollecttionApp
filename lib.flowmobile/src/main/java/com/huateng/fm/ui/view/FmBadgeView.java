 ...
 * 
 */
public class FmBadgeView extends TextView {
	...
	public FmBadgeView(Context context) {
		this(context, (AttributeSet) null, android.R.attr.textViewStyle);
	}
	
	public FmBadgeView(Context context, AttributeSet attrs) {
     ...
     */
	public FmBadgeView(Context context, View target) {
     ...
     */
	public FmBadgeView(Context context, TabWidget target, int index) {
		this(context, null, android.R.attr.textViewStyle, target, index);
	}
	
	public FmBadgeView(Context context, AttributeSet attrs, int defStyle) {
		this(context, attrs, defStyle, null, 0);
	}
	
	public FmBadgeView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
