 ...
 */
public class FmNumericProgressBar extends View {
	...
	public FmNumericProgressBar(Context context) {
		super(context);
	}

	public FmNumericProgressBar(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	private void init(AttributeSet attrs, int defStyleAttr) {
		...
		final TypedArray attributes = mContext.getTheme()
				.obtainStyledAttributes(attrs,
						R.styleable.ht_NumericProgressBar, defStyleAttr, 0);

		mReachedBarColor = attributes.getColor(
				R.styleable.ht_NumericProgressBar_reachedColor,
				default_reached_color);
		mUnreachedBarColor = attributes.getColor(
				R.styleable.ht_NumericProgressBar_unreachedColor,
				default_unreached_color);
		mTextColor = attributes
				.getColor(R.styleable.ht_NumericProgressBar_textColor,
						default_text_color);
		mTextSize = attributes.getDimension(
				R.styleable.ht_NumericProgressBar_textSize, default_text_size);

		mReachedBarHeight = attributes.getDimension(
				R.styleable.ht_NumericProgressBar_reachedBarHeight,
		...
		mOffset = attributes.getDimension(
				R.styleable.ht_NumericProgressBar_textOffset,
				default_progress_text_offset);

		int textVisible = attributes.getInt(
				R.styleable.ht_NumericProgressBar_textVisibility,
		...
		setProgress(attributes.getInt(
				R.styleable.ht_NumericProgressBar_progressNum, 0));
		setMax(attributes.getInt(R.styleable.ht_NumericProgressBar_max, 100));
		//
		attributes.recycle();
