...
public class SmoothProgressDrawable extends Drawable implements Animatable {
  ...
  public static class Builder {
    ...
    private void initValues(Context context) {
      ...
      mSectionsCount = 4;
      mColors = new int[]{res.getColor(R.color.smooth_progressbar_default_color)};
      mSpeed = Float.parseFloat("1.0");
      mProgressiveStartSpeed = mSpeed;
      mProgressiveStopSpeed = mSpeed;
      mReversed = false;
      mStrokeSeparatorLength = res.getDimensionPixelSize(R.dimen.ht_complex_smoothProgressbar_stroke_separator_length);
      mStrokeWidth = res.getDimensionPixelOffset(R.dimen.ht_complex_smoothProgressbar_stroke_width);
