...
import com.huateng.fm.ui.widget.FmCheckBox.CheckStyle;
...
public class FmRadioButton extends RadioButton implements Observer{
    ...
    public FmRadioButton(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.ht_RadioButton);

            // getting common attributes
            mAttrValues.setSize(a.getDimensionPixelSize(R.styleable.ht_RadioButton_totalSize, FmAttributeValues.DEFAULT_SIZE_PX));
            mAttrValues.setRadius(mAttrValues.getSize() / 2);
        	mCornerStyle = a.getInt(R.styleable.ht_RadioButton_cornerStyle,
					FmAttributeValues.CornerStyle.ROUND);
            mDotMargin = a.getDimensionPixelSize(R.styleable.ht_RadioButton_dotMargin, mDotMargin);
            mCheckStyle = a.getInt(R.styleable.ht_RadioButton_checkStyle,
					CheckStyle.DOT);
            mBorderColor=a.getColor(R.styleable.ht_RadioButton_borderColor, FmAttributeValues.GRAY_BORDER_COLOR);
			mCheckedDrawable=a.getDrawable(R.styleable.ht_RadioButton_checkedDrawable);
			mUnCheckedDrawable=a.getDrawable(R.styleable.ht_RadioButton_unCheckedDrawable);
    ...
    private void initValues(){
		mDotMargin=(int)getResources().getDimension(R.dimen.ht_widget_dot_margin);
	}
