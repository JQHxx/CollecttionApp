...
import com.huateng.phone.collection.bean.api.RespPaymentCalItem;
import com.huateng.phone.collection.network.CommonInteractor;
import com.huateng.phone.collection.network.RequestCallbackImpl;
...
public class AccountInfoAdapter extends BaseQuickAdapter<AccountInfoBean.RecordsBean, BaseViewHolder> {
     ...
     * @param map
     */
    public void requestPamentCalculate(HashMap<String, Object> map) {
