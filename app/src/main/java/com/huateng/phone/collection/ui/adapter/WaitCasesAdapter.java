...
/**
 * author: yichuan
 * Created on: 2020/7/13 15:15
 * description:
 */
public class WaitCasesAdapter extends BaseQuickAdapter<CaseBeanData.RecordsBean, BaseViewHolder> {
    ...
    protected void convert(final BaseViewHolder helper, final CaseBeanData.RecordsBean item) {
        ...
        helper.setText(R.id.right_menu_2,"移除");
    ...
    public TodoCasesAdapter.OnItemClickListener mOnItemClickListener;

    public void setOnSwipeMenuListener(TodoCasesAdapter.OnItemClickListener onSwipeMenuListener) {
