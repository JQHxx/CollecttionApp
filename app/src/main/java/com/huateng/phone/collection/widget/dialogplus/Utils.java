...
final class Utils {
  ...
  static int getAnimationResource(int gravity, boolean isInAnimation) {
    if ((gravity & Gravity.TOP) == Gravity.TOP) {
      return isInAnimation ? R.anim.dialogplus_slide_in_top : R.anim.dialogplus_slide_out_top;
    }
    if ((gravity & Gravity.BOTTOM) == Gravity.BOTTOM) {
      return isInAnimation ?R.anim.dialogplus_slide_in_bottom :R.anim.dialogplus_slide_out_bottom;
    }
    if ((gravity & Gravity.CENTER) == Gravity.CENTER) {
      return isInAnimation ?R.anim.dialogplus_fade_in_center : R.anim.dialogplus_fade_out_center;
    }
    return INVALID;
  }
}
