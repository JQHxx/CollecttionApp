...
package com.huateng.phone.collection.widget.appmsg;
...
public class AppMsg {
     ...
     */
    public static final Style STYLE_ERROR = new Style(LENGTH_SHORT, R.color.error);
    ...
    public static final Style STYLE_NORMAL = new Style(LENGTH_SHORT, R.color.normal);
