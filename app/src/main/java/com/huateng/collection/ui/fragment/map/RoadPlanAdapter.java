...
public class RoadPlanAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = 
					View.inflate(mContext, R.layout.list_routeline_item, null);
			viewHolder.label = (TextView) convertView.findViewById(R.id.transitName);
			viewHolder.desc = (TextView) convertView.findViewById(R.id.dis);
