...
public class RecordService extends Service {
    ...
    RecordTask getTask(Intent intent, RecordTask.RecordStatusDelegate delegate) {
        ...
        intent.putExtra(AndroidAudioRecorder.EXTRA_SAMPLE_RATE,AudioSampleRate.HZ_32000);
...
//        pendIntent.setAction()
     ...
     */
    protected static void setRecordStatusDelegate(RecordTask.RecordStatusDelegate delegate) {
        if (delegate == null) {
            return;
        }
