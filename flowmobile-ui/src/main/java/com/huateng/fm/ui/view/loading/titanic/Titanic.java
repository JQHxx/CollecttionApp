...
public class Titanic {
    ...
    public void start(final FmTitanicTextView textView) {
        ...
        if (!textView.isSetUp()) {
            textView.setAnimationSetupCallback(new FmTitanicTextView.AnimationSetupCallback() {
                @Override
                public void onSetupAnimation(final FmTitanicTextView target) {
                    animate.run();
                }
            });
        } else {
