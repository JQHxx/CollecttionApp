 ...
 */
public class FmAutoCompleteTextView extends AppCompatAutoCompleteTextView implements Observer{
	...
	private void init(AttributeSet attrs) {
		...
		if (attrs != null) {
			...
			mCornerStyle = a.getInt(R.styleable.ht_AutoCompleteTextView_cornerStyle,
					FmAttributeValues.CornerStyle.ROUND);
			mLabelText = a.getString(R.styleable.ht_AutoCompleteTextView_labelText);
			mLabelPadding=(int) a.getDimension(R.styleable.ht_AutoCompleteTextView_labelPadding, FmAttributeValues.ht2dp);
			...
			setPadding( mInitLeftPadding+2*FmAttributeValues.ht2dp, mInitTopPadding, mInitRightPadding +mOptionIconPadding+mOptionIconSize,
					mInitBottomPadding);
		}
		setSingleLine(true);
	}
...
//		                    }  
		    ...
		    public View getView(final int position, View convertView, ViewGroup parent) {  
		        ...
		        if(convertView==null){  
		            ...
		            holder.tv_text=(TextView)convertView.findViewById(R.id.text);    
...
//		        });  
	...
	private void setCornerRadius(int cornerStyle) {
		switch (cornerStyle) {
