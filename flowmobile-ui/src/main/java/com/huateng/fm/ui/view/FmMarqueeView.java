...
public class FmMarqueeView extends LinearLayout {
    ...
    private static final String TAG = FmMarqueeView.class.getSimpleName();
    ...
    public FmMarqueeView(Context context) {
        super(context);
        init(context);
    }

    @SuppressWarnings({"UnusedDeclaration"})
    public FmMarqueeView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public FmMarqueeView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void extractAttributes(AttributeSet attrs) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.ht_MarqueeView);

        if (a == null) {
            return;
        }

        mSpeed = a.getInteger(R.styleable.ht_MarqueeView_marqueeSpeed, DEFAULT_SPEED);
        mAnimationPause = a.getInteger(R.styleable.ht_MarqueeView_pause, DEFAULT_ANIMATION_PAUSE);
        mAutoStart = a.getBoolean(R.styleable.ht_MarqueeView_autoStart, true);
