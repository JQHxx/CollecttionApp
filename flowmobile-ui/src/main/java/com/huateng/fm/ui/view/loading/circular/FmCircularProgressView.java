 ...
 */
public class FmCircularProgressView extends View {
    ...
    public FmCircularProgressView(Context context) {
        super(context);
        init(null, 0);
    }

    public FmCircularProgressView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public FmCircularProgressView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initAttributes(AttributeSet attrs, int defStyle)
    {
        final TypedArray a = getContext().obtainStyledAttributes(
                attrs, R.styleable.FmCircularProgressView, defStyle, 0);

        Resources resources = getResources();

        // Initialize attributes from styleable attributes
        currentProgress = a.getFloat(R.styleable.FmCircularProgressView_progress,
                0);
        maxProgress = a.getFloat(R.styleable.FmCircularProgressView_maxProgress,
               100);
        thickness = a.getDimensionPixelSize(R.styleable.FmCircularProgressView_t_thickness,
        		4);
        isIndeterminate = a.getBoolean(R.styleable.FmCircularProgressView_indeterminate,
        		false);
        autostartAnimation = a.getBoolean(R.styleable.FmCircularProgressView_animAutostart,
               false);
        ...
        if (a.hasValue(R.styleable.FmCircularProgressView_h_color2)) {
            color = a.getColor(R.styleable.FmCircularProgressView_h_color2, FmAttributeValues.PRIMARY_COLOR);
        }
...
//        }
            ...
            //Use default color
            color = FmAttributeValues.PRIMARY_COLOR;
        }

        animDuration = a.getInteger(R.styleable.FmCircularProgressView_animDuration,
        		4000);
        animSwoopDuration = a.getInteger(R.styleable.FmCircularProgressView_animSwoopDuration,
        		5000);
        animSyncDuration = a.getInteger(R.styleable.FmCircularProgressView_animSyncDuration,
        		500);
        animSteps = a.getInteger(R.styleable.FmCircularProgressView_animSteps,3);
        a.recycle();
    }
    ...
    public void setProgress(final float currentProgress) {
    	Log.e("CIRCULAR", "-----setProgress---:"+currentProgress);
