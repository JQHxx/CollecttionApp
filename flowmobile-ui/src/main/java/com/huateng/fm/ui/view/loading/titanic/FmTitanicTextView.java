 ...
 * 13/03/2014
 */
public class FmTitanicTextView extends TextView {

    public interface AnimationSetupCallback {
        public void onSetupAnimation(FmTitanicTextView titanicTextView);
    }
    ...
    public FmTitanicTextView(Context context) {
        super(context);
        init();
    }

    public FmTitanicTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public FmTitanicTextView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (!setUp) {
            ...
            if (animationSetupCallback != null) {
                animationSetupCallback.onSetupAnimation(FmTitanicTextView.this);
            }
        }
    }
