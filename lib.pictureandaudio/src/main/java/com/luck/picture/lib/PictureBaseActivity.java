...
public class PictureBaseActivity extends FragmentActivity {
    ...
    protected String originalPath, outputCameraPath, processId, processName;
                ...
                new CompressInterface.CompressListener() {
                    ...
                    public void onCompressSuccess(List<LocalMedia> images) {
                       // RxBus.get().post(new EventEntity());
                        EventBus.getDefault().post(new EventBean(PictureConfig.CLOSE_PREVIEW_FLAG));
                        onResult(images);
                    }
    ...
    protected void onResult(List<LocalMedia> images) {
        ...
        if (camera
            ...
            for (int i=0;i<selectionMedias.size();i++){
                Log.e("nb",selectionMedias.get(i).toString());
            }
        }
