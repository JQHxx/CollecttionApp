...
public class PictureSelectorActivity extends PictureBaseActivity implements View.OnClickListener,
    ...
    public void eventBus(EventBean bean) {
        ...
        if(bean.getCode() == PictureConfig.UPDATE_FLAG) {
            EventEntity obj = (EventEntity) bean.getObject();
            // 预览时勾选图片更新回调
        ...
        }else if(bean.getCode() == PictureConfig.PREVIEW_DATA_FLAG) {
            EventEntity obj = (EventEntity) bean.getObject();
                ...
                .subscribe(new Consumer<Boolean>() {
                    ...
                    public void accept(Boolean aBoolean) throws Exception {
                        if (aBoolean) {
                            ...
                            //@see Util 设置 PCM
                            Log.e("nb","cameraPath-->:"+cameraPath);
                            AndroidAudioRecorder.with(PictureSelectorActivity.this)
                                    // Required
                                    .setFilePath(cameraPath)
                                    //taskId
                                    .setTaskId(processId)
                                    .setTaskName(processName)
                                    .setColor(ContextCompat.getColor(PictureSelectorActivity.this, R.color.colorPrimary))
     ...
     * @param media
     */
    private void audioDialog(LocalMedia media) {
        ...
        tv_musicName = (TextView) audioDialog.findViewById(R.id.tv_musicName);
        tv_musicName.setText(media.getPath());
