...
public final class PictureSelectionConfig implements Parcelable {
    ...
    public String toString() {
        return "PictureSelectionConfig{" +
                "mimeType=" + mimeType +
                ", camera=" + camera +
                ", outputCameraPath='" + outputCameraPath + '\'' +
                ", processId='" + processId + '\'' +
                ...
                ", enPreviewVideo=" + enPreviewVideo +
                ", enablePreviewAudio=" + enablePreviewAudio +
                ", checkNumMode=" + checkNumMode +
                ", openClickSound=" + openClickSound +
                ", previewEggs=" + previewEggs +
                ", selectionMedias=" + selectionMedias +
                '}';
    }
}
