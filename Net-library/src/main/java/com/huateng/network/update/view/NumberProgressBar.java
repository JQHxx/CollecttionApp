package com.huateng.network.update.view;
...
public class NumberProgressBar extends View {
    ...
    public NumberProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int textVisible = attributes.getInt(R.styleable.UpdateAppNumberProgressBar_uap_progress_text_visibility, PROGRESS_TEXT_VISIBLE);
