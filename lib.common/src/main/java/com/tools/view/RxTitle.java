...
public class RxTitle extends FrameLayout {
    ...
    private LinearLayout mLlTitle;//左边布局

    private TextView mTvTitle;//Title的TextView控件

    private ImageView mIvTitle;//Title的ImageView控件
    ...
    private int mTitleIcon;//中间 ICON 引用的资源ID

    private int mRightIcon;//右边 ICON 引用的资源ID

    private boolean mLeftIconVisibility;//左边 ICON 是否显示

    private boolean mTitleIconVisibility;//中间 ICON 是否显示
    ...
    private void initView(final Context context, AttributeSet attrs) {
        ...
        mLlTitle = (LinearLayout) findViewById(R.id.ll_middle);
        mTvTitle = (TextView) findViewById(R.id.tv_rx_title);
        mIvTitle = (ImageView) findViewById(R.id.iv_title_icon);
        ...
        try {
            ...
            //中间图标的显示
            mTitleIconVisibility = a.getBoolean(R.styleable.RxTitle_rxTitleIconVisibility, false);

            mLeftIcon = a.getResourceId(R.styleable.RxTitle_rxLeftIcon, R.drawable.back);//左边图标
            mTitleIcon = a.getResourceId(R.styleable.RxTitle_rxTitleIcon, R.drawable.set);
        ...
        if (mTitleIcon != 0) {
            setTitleIcon(mTitleIcon);
        }

        setTitleVisibility(mTitleVisibility);

        setTitleIconVisibility(mTitleIconVisibility);
...
//        mLlRight.setOnClickListener(onClickListener);
        throttleFirst(mLlRight, onClickListener);
    }
    ...
    public void setTitleIconVisibility(boolean titleIconVisibility) {
        mTitleIconVisibility = titleIconVisibility;
        if (mTitleIconVisibility) {
    ...
    public void setTitleIcon(int titleIcon) {
        ...
        mIvTitle.setImageResource(mTitleIcon);
    }
