...
public class PicturePlayAudioFragment extends DialogFragment implements View.OnClickListener {
    private String audio_path;
    private MediaPlayer mediaPlayer;
    private SeekBar musicSeekBar;
    private boolean isPlayAudio = false;
    private TextView tv_PlayPause, tv_Stop, tv_Quit,
            tv_musicStatus, tv_musicTotal, tv_musicTime,tv_musicName;


    public static PicturePlayAudioFragment newInstance(String path){
        PicturePlayAudioFragment fragment = new PicturePlayAudioFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_picture_play_audio,null);
        audio_path = getArguments().getString("path");
        //audio_path = getIntent().getStringExtra("audio_path");
        tv_musicStatus = (TextView) view.findViewById(R.id.tv_musicStatus);
        tv_musicTime = (TextView) view.findViewById(R.id.tv_musicTime);
        tv_musicName= (TextView) view.findViewById(R.id.tv_musicName);
        tv_musicName.setText(audio_path);
        tv_musicName.setSelected(true);
        musicSeekBar = (SeekBar) view.findViewById(R.id.musicSeekBar);
        tv_musicTotal = (TextView) view.findViewById(R.id.tv_musicTotal);
        tv_PlayPause = (TextView) view.findViewById(R.id.tv_PlayPause);
