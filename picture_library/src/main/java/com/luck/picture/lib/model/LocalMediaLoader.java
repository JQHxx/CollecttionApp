...
public final class LocalMediaLoader {
    ...
    public List<LocalMedia> getImages(String path) {
        ...
        if (cursor.moveToFirst()) {
            do {
                LocalMedia fileItem = new LocalMedia();

                fileItem.setPath(cursor.getString(cursor.getColumnIndexOrThrow(MediaStore.Images.Media.DATA)));
                ...
                fileItem.setWidth(cursor.getInt(cursor.getColumnIndexOrThrow(MediaStore.Images.Media.WIDTH)));
                fileItem.setHeight(cursor.getInt(cursor.getColumnIndexOrThrow(MediaStore.Images.Media.HEIGHT)));
    ...
    public List<LocalMedia> getAudios(String path) {
        ArrayList<LocalMedia> images = new ArrayList<LocalMedia>();
        String[] mediaColumns = new String[]{
        ...
        Cursor cursor = mContext.getContentResolver().query(
                ...
                mediaColumns, selection, selectionArgs, MediaStore.Audio.Media.DATE_MODIFIED + " DESC");//MediaStore.Video.Media.DATE_TAKEN+ " DESC"
