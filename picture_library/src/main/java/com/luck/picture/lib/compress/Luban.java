...
public class Luban {
    ...
    public void launch(final OnCompressListener listener) {
        ...
        asObservable().subscribeOn(Schedulers.computation()).observeOn(AndroidSchedulers.mainThread()).subscribe(new Subscriber<File>() {
...
//                });
        ...
        asListObservable().subscribeOn(Schedulers.computation()).observeOn(AndroidSchedulers.mainThread()).subscribe(new Subscriber<List<File>>() {
            @Override
            public void onStart() {
                super.onStart();
                listener.onStart();
