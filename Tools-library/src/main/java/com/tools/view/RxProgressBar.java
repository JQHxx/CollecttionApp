...
public class RxProgressBar extends View implements Runnable {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        try {
            textSize = (int) ta.getDimension(R.styleable.FlikerProgressBar_fpTextSize, 12);
            loadingColor = ta.getColor(R.styleable.FlikerProgressBar_fpLoadingColor, Color.parseColor("#40c4ff"));
            pauseColor = ta.getColor(R.styleable.FlikerProgressBar_fpStopColor, Color.parseColor("#ff9800"));
            finishColor = ta.getColor(R.styleable.FlikerProgressBar_fpFinishColor, Color.parseColor("#3CB371"));
            radius = (int) ta.getDimension(R.styleable.FlikerProgressBar_fpRadius, 0);
            borderWidth = (int) ta.getDimension(R.styleable.FlikerProgressBar_fpBorderWidth, 1);
        } finally {
            ta.recycle();
        }
    }
